...
int32_t main(){
    ...
    Order order2(2,OrderType::MARKET,2,10,Side::BUY,25);
    Order order3(3,OrderType::MARKET,2,10,Side::BUY,30);
    Order order4(4,OrderType::MARKET,2,10,Side::BUY,35);
    Order order5(5,OrderType::MARKET,2,10,Side::BUY,40);
    Order order6(6,OrderType::MARKET,2,81,Side::BUY,40);
    Order order7(7,OrderType::MARKET,2,10,Side::SELL,20);
    Order order8(8,OrderType::MARKET,2,10,Side::SELL,25);
    Order order9(9,OrderType::MARKET,2,5,Side::SELL,30);
